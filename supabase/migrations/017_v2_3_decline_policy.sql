...
insert into public.canonical_decline_reasons(
  ...
  ('ACTIVE_DAS','public_adverse','longer_term_recovery','structural_long_horizon',false,true,false,'longer_term','published',now()),
  ...
  ('RETURNED_PAYMENT_RECENT','delinquency','stabilise','stabilise_first',false,true,false,'stabilise','published',now()),
  ...
  ('RECURRING_ACCOUNT_SHORTFALL','affordability','create_headroom','stabilise_first',false,true,false,'create_headroom','published',now()),
  ...
  ('UNARRANGED_OVERDRAFT_FREQUENT','indebtedness','stabilise','stabilise_first',false,true,false,'stabilise','published',now()),
  ...
  ('BUREAU_ASSOCIATION_DATA_REVIEW','data_integrity','fix','fix_now',false,true,false,'data_check','published',now()),
  ...
  ('RESIDENCY_POLICY_NOT_MET','product_fit','needs_evidence','unknown_or_unmapped',false,false,false,'eligibility_policy','published',now()),
  ('PRODUCT_AGE_POLICY_NOT_MET','product_fit','needs_evidence','unknown_or_unmapped',false,false,false,'eligibility_policy','published',now()),
  ('RISK_SCORE_BELOW_CUTOFF','policy_or_score','needs_evidence','unknown_or_unmapped',false,false,false,'need_more_information','published',now()),
  ('INTERNAL_SCORE_BELOW_CUTOFF','policy_or_score','needs_evidence','unknown_or_unmapped',false,false,false,'need_more_information','published',now()),
  ('AFFORDABILITY_SCORE_BELOW_CUTOFF','policy_or_score','needs_evidence','unknown_or_unmapped',false,false,false,'need_more_information','published',now()),
  ('SCORE_DECLINE_UNEXPLAINED','policy_or_score','needs_evidence','unknown_or_unmapped',false,false,false,'need_more_information','published',now()),
