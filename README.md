...
- V2.3 persistence is additive through `017_v2_3_decline_policy.sql`, `018_v2_3_multi_reason_snapshots.sql` and `019_v2_3_lender_pilot_reporting.sql`; V2.0d recovery privilege and credential-vault hardening remain in migrations `015` and `016`.
